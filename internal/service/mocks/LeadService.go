...
// GetStatusCounts provides a mock function with no fields
func (_m *LeadService) GetStatusCounts() (map[string]int64, error) {
	ret := _m.Called()
...
func (_m *LeadService) GetRecent(limit int) ([]models.Lead, error) {
	ret := _m.Called(limit)
...
// GetRecentByOwner provides a mock function with given fields: ownerID, limit
func (_m *LeadService) GetRecentByOwner(ownerID uint, limit int) ([]models.Lead, error) {
...
// GetRecentlyConverted provides a mock function with given fields: limit
func (_m *LeadService) GetRecentlyConverted(limit int) ([]models.Lead, error) {
	ret := _m.Called(limit)
...
// GetConversionTimestamps provides a mock function with given fields: since
func (_m *LeadService) GetConversionTimestamps(since time.Time) ([]time.Time, error) {
	ret := _m.Called(since)
