...
// GetByEmailUnscoped provides a mock function with given fields: email
func (_m *UserRepository) GetByEmailUnscoped(email string) (*models.User, error) {
	ret := _m.Called(email)
...
func (_m *UserRepository) ListSorted(offset int, limit int, sortBy string, sortOrder string) ([]models.User, error) {
	ret := _m.Called(offset, limit, sortBy, sortOrder)

	var r0 []models.User
	var r1 error
	if rf, ok := ret.Get(0).(func(int, int, string, string) ([]models.User, error)); ok {
...
func (_m *UserRepository) Search(query string, offset int, limit int, sortBy string, sortOrder string) ([]models.User, error) {
	ret := _m.Called(query, offset, limit, sortBy, sortOrder)

	var r0 []models.User
	var r1 error
	if rf, ok := ret.Get(0).(func(string, int, int, string, string) ([]models.User, error)); ok {
...
func (_m *UserRepository) CountSearch(query string) (int64, error) {
	ret := _m.Called(query)
