...
var _ repository.LeadRepository = (*LeadRepository)(nil)
...
func (_m *LeadRepository) GetByExternalID(externalID string) (*models.Lead, error) {
...
func (_m *LeadRepository) CountByClassification(classification models.LeadClassification) (int64, error) {
